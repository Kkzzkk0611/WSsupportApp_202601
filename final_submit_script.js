...
const CONFIG = {
    ...
    PAGES: {
        hazard: '../hazard/hazard_map.html',        // ← 対象地点/ハザードマップ選択ページ
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Set today as default creation date
...
function initializeInputs() {
    ...
    if (appData.artwork.creationDate) {
        dateInput.value = appData.artwork.creationDate;
    }
